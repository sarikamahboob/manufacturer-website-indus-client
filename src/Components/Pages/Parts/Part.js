      ...
      <div class="card w-full bg-base-100 shadow-xl">
        ...
        <div class="card-body">
          ...
          <div class="card-actions justify-end mt-4">
            <button
              onClick={() => navigate(`/purchase/${_id}`)}
              class="btn btn-primary w-full max-w-xs text-base-100 transition hover:bg-base-100 hover:border-accent hover:text-accent hover:ease-in-out hover:duration-300"
            >
              Buy Now
            </button>
          </div>
